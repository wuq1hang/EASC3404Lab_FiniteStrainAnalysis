...
\begin{enumerate}
  \item No submission required for Questions 1 and 2. They will be discussed in class.
  \item Provide brief answers to Questions 3 and 4. 
    Also print out your \texttt{Jupyter Notebook} scripts associated with both question,
    (with all figure outputs included) for submission.
  \item Submit your measurement steps and results for Question 4.
\end{enumerate}
...
\begin{figure}[hbpt!]
  \includegraphics[width=\linewidth]{measurement_method.pdf}
\end{figure}
\begin{enumerate}
